...
export function ChartTooltip({ content, defaultIndex, cursor = true, ...props }: ChartTooltipProps) {
  return <></>
}
...
export function ChartTooltipContent({ hideLabel = false, ...props }: ChartTooltipContentProps) {
  return <></>
}
